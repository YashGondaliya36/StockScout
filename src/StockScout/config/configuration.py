...
from src.StockScout.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,PartialModelTrainerConfig,ModelEvaluationConfig,FullModelTrainerConfig
